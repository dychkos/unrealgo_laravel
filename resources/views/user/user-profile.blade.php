                    ...
                    <div class="user-profile__input-group col-12 col-md-6">
                        ...
                        <div class="edit-photo">
                            <div class="edit-photo__preview">
                                <img
                                    src="{{isset($user->image) ?  asset($user->image->filename) : asset('app/img/avatar-default.png')}}"
                                    id="photo-preview" alt="Profile"
                                />
                            </div>
                            <div class="edit-photo__edit">
                                <div class="form-input input-group__input" >
                                    <input type="file" class="edit-photo__input" id="edit-photo" name="image">
                                </div>
...
@once
    @push('js')
        ...
        <script src="{{ asset('application/js-min/user-profile.min.js?v=' . random_int(1000, 9999)) }}"></script>
    @endpush
@endonce

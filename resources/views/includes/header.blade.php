...
{{--                    <a href="{{ route('articles.index') }}" class="h6 link">--}}
{{--                        Блог--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <div class="header__link">--}}
            ...
            <div class="container">
                <div class="user-dropdown__body">
                    ...
                    <div class="user-dropdown__item link">
                        ...
                        <span class="h5"><a href="{{route('basket')}}">Кошик</a></span>
                    </div>
                    <div class="user-dropdown__item link">
                        <i class="fa-regular fa-heart"></i>
                        <span class="h5"><a href="{{route('user.liked')}}">Вподобане</a></span>
                    </div>
                    <div class="user-dropdown__item link">
                        <i class="fa fa-bars"></i>
                        <span class="h5"><a href="{{route('user.order-history')}}">Мої замовлення</a></span>
                    </div>

                    <div class="user-dropdown__item link">
                        <i class="fa-regular fa-user"></i>
                        <span class="h5"><a href="{{route('user.profile')}}">Профіль</a></span>
                    </div>
                    @if (isset($user) && $user->isAdmin())
                        <div class="user-dropdown__item link">
                            <i class="fa-brands fa-angellist"></i>
                            <span class="h5"><a href="{{route('user.admin.index')}}">Адмін-панель</a></span>
                        </div>
                    @endif
...
{{--                        </div>--}}
                        @if(\Illuminate\Support\Facades\Auth::check())
                            ...
                            @if (isset($user) && $user->isAdmin())
                                <div class="header-mobile__link">
                                    <a href="{{route('user.admin.index')}}">Admin-panel</a>
                                </div>
                            @endif
                            <div class="header-mobile__link">

    ...
    <div class="header-desktop">
        <div class="container header__row">
            ...
            <div class="header__col">
                ...
                <div class="header__link">
                    <a class="special-button h6" href="{{ route("marathon") }}">
                        <span>Марафон</span>
                        <span>
                            <svg width="24px" height="24px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                @if( \Illuminate\Support\Facades\Auth::check())
                    <div class="user-dropdown__preview" id="hide-if-no-size">
                ...
                @else
                    <a href="{{route('login.index')}}" id="hide-if-no-size">

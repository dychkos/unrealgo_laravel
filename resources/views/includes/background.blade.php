<div class="backwrap gradient">
    <div class="back-shapes">
        <img alt="animated_elem" src="{{asset('app/img/trophy.png')}}" class="floating"
             style="top:66.59856996935649%;left:13.020833333333334%;animation-delay:-0.9s;">
        <img alt="animated_elem" src="{{asset('app/img/run.png')}}" class="floating"
             style="top:31.46067415730337%;left:33.59375%;animation-delay:-4.8s;">
        <img alt="animated_elem" src="{{asset('app/img/cross.png')}}" class="floating"
             style="top:76.50663942798774%;left:38.020833333333336%;animation-delay:-4s" ;>
        <img alt="animated_elem" src="{{asset('app/img/meditation.png')}}" class="floating"
             style="top:21.450459652706844%;left:14.0625%;animation-delay:-2.8s;">
        <img alt="animated_elem" src="{{asset('app/img/square.png')}}" class="floating"
        ...
        <img alt="animated_elem" src="{{asset('app/img/reading.png')}}" class="floating"
        ...
        <img alt="animated_elem" src="{{asset('app/img/ug.png')}}" class="floating"

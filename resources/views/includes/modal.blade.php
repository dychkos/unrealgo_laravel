<div class="modal-wrapper" style="display: none">
    <div class="modal">
        ...
        <div class="modal__header h3">
            Модальное окно
        </div>
        <div class="modal__body">
            <p class="p">Контент модального окна. Может быть всякий рандомный контент</p>
        </div>
        <div class="modal__footer">
            <div class="modal__action-first">Первое действие</div>
            <div class="modal__action-second">Второе действие</div>
        </div>
    </div>
</div>

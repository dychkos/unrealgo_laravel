...
@section("content")
                                            ...
                                            <div class="large-article__watcher with-icon">
                                                <div class="with-icon__icon">
                                                    <svg width="23" height="24" viewBox="0 0 23 24" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M20.8246 12C20.8246 12 16.6705 18 11.5138 18C6.35703 18 2.20297 12 2.20297 12C2.20297 12 6.35703 6 11.5138 6C16.6705 6 20.8246 12 20.8246 12Z"
                                                            stroke="#A5A815" stroke-width="2" stroke-miterlimit="10"
                                                            stroke-linejoin="round"/>
                                                        <path
                                                            d="M11.5138 15C13.096 15 14.3787 13.6569 14.3787 12C14.3787 10.3431 13.096 9 11.5138 9C9.93157 9 8.64893 10.3431 8.64893 12C8.64893 13.6569 9.93157 15 11.5138 15Z"
                                                            stroke="#A5A815" stroke-width="2" stroke-miterlimit="10"
                                                            stroke-linejoin="round"/>
                                                    </svg>
                                                </div>
    ...
    @endif
    <section class="mb-6">
        <div class="banner__wrapper swiper-banner mb-5">
            <div class="swiper-wrapper">
                <div class="swiper-slide banner">
                    <div class="banner__background photo">
                        <img src="{{ asset("app/img/banner_novaposhta.png") }}" alt="Banner">
                    </div>
                    <div class="banner__card">
                        <div class="h2">Безкоштовна доставка в честь відкриття*</div>
                        <p class="p-light">*Термін безкоштовної доставки до 30.08.2023</p>
                        <a role="button" href="{{route('store.index')}}" class="btn btn_primary h6 mt-3">До каталогу</a>
                    </div>
                </div>
                <div class="swiper-slide banner">
                    <div class="banner__background photo">
                        <img src="{{ asset("app/img/banner_army.jpg") }}" alt="Banner">
                    </div>
                    <div class="banner__card">
                        <div class="h2">Допомагаємо ЗСУ!</div>
                        <p class="p">10% прибутку перераховуємо на допомогу військовим.</p>
                        <a role="button" href="{{route('store.index')}}" class="btn btn_primary h6 mt-3">До каталогу</a>
                    </div>
                </div>
                <div class="swiper-slide banner">
                    ...
                    <div class="banner__card">
                        <div class="h2">Український бренд про саморозвиток</div>
                        <p class="p">Гарна можливість підтримати український стартап.</p>
                    </div>
                </div>
            </div>
            <div class="swiper-pagination banner__pagination mt-2"></div>
        </div>
                            ...
                            <div class="swiper-wrapper">
                                @foreach($popularProducts as $product)
                                    <div class="swiper-slide">
                                        <a href="{{route("store.show", [$product->type->slug, $product->id])}}"

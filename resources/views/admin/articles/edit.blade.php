...
@section('content')
    ...
    <form class="admin-one admin-form"
          action="{{route('user.admin.articles.update', $article->id)}}"
        ...
        <div class="admin-row">
            <div class="form-input">
                ...
                <textarea
                    ...
                    placeholder="Введите текст" rows="4">{{old('description', $article->description)}}</textarea>
                @error("description")
                <div class="required_alert">{{$message}}</div>
                @enderror
            </div>
        ...
        <div class="admin-row">
            <div class="form-input">
                ...
                <textarea
                    ...
                    placeholder="Введите текст" rows="10">{{$article->body}}</textarea>
                @error("body")
                <div class="required_alert">{{$message}}</div>
                @enderror
            </div>

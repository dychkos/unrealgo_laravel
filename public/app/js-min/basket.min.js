...
var Mask = /*#__PURE__*/function () {
  ...
  _createClass(Mask, null, [{
    key: "phoneNumber",
    value: function phoneNumber(phoneString) {
      var x = phoneString.replace(/\D/g, "").match(/(\d{0,3})(\d{0,3})(\d{0,4})/);
  ...
  _createClass(Basket, null, [{
    ...
    value: function init() {
      ...
      phoneInput.addEventListener("input", function (e) {
        e.target.value = _includes_Mask__WEBPACK_IMPORTED_MODULE_0__["default"].phoneNumber(e.target.value);
      });

...
var Auth = /*#__PURE__*/function (_MainController) {
  _inherits(Auth, _MainController);
  ...
  _createClass(Auth, null, [{
    key: "init",
    value: function init() {
      _get(_getPrototypeOf(Auth), "init", this).call(this);

      var modal = new _includes_Modal__WEBPACK_IMPORTED_MODULE_0__["default"](Auth.nodes.privacyBtn, ".modal-wrapper");
      modal.setTitle("ПОЛІТИКА КОНФІДЕНЦІЙНОСТІ").setDescription(_includes_innerText__WEBPACK_IMPORTED_MODULE_1__.privacyHtml).init();
    }
  }]);
